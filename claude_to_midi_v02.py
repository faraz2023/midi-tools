...
def create_ai_midi(genre="", instrument="", length="", description="", prompt_file_path=None, output_file=None):
    ...
    if(not prompt_file_path):
        ...
        assert output_file is not None, "Output file path should be provided when using a prompt file"
    ...
    if(not output_file):
        output_file = f"{genre}_{instrument}_{length}_loop.mid"

    create_midi_from_text(cleaned_midi_text, output_file)
    print(f"AI-generated MIDI file '{output_file}' has been created.")
...
if __name__ == "__main__":
    try:
        ...
        create_ai_midi(prompt_file_path="prompts/dark_melodic_house_bassline.txt", output_file="house_dark_bassline.mid")
